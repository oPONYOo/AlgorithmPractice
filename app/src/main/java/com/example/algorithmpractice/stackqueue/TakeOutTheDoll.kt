...
/*
[풀기 전]
m-1만큼 for문 실행 바구니 moves 요소 순서로 인형 담기
바구니 Stack
0이 아니면 push
...
private fun solutionCode(n: Int, board: Array<Array<Int>>, m: Int, moves: Array<Int>): Int {
    var answer = 0
...
fun main() {
    ...
    println(solutionCode(n, board, m, moves))
